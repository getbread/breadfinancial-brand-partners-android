...
```gradkotlinle
implementation("com.breadfinancial.breadpartners.sdk:breadpartners-sdk:0.0.1")
```
#### b. Select the appropriate version (or branch) for your project.
```renderscript
./gradlew -refresh-dependencies
```

#### c, Import the `BreadPartnersSDK` to whichever class you need to utilize the SDK in:
